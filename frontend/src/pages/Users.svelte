...
<div class="space-y-4">
  ...
  <div class="rounded-lg border border-gray-200 bg-white p-4">
    ...
    <form on:submit|preventDefault={handleCreate} class="space-y-3">
      ...
      <button type="submit" disabled={loading} aria-busy={loading} class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700">
